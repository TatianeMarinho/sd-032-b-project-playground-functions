...
Implementar o código de funções que resolvem problemas com respostas pré-determinadas. Utilizando a lógica de programação para te ajudar na análise de cada problema e resposta esperada, facilitando a implementação do código de cada uma das funções.
...
O projeto contém os arquivos `challenges.js` e `challenges2.js` com as funções implementadas utilizando os mesmos nomes solicitados nos exercicíos.
...
<details>
  ...
  Este projeto já vem com as dependências relacionadas ao _linter_ configuradas no arquivo `package.json`. Criado pela Trybe.
...
<details>
  <summary><strong>Links auxiliares usados para o desenvolvimento do projeto</strong></summary><br />
...
<br>
*Exercicíos desenvolvidos pela [Trybe](https://www.betrybe.com/).

<!-- Olá, Tryber!
Esse é apenas um arquivo inicial para o README do seu projeto.
É essencial que você preencha esse documento por conta própria, ok?
Não deixe de usar nossas dicas de escrita de README de projetos, e deixe suaa criatividade brilhar!
